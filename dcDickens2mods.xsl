...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="dc:relation">
	   <xsl:choose>
		<xsl:when test="contains(text(), 'Illustrations to Dickens')">
           <relatedItem type="host">
			   ...
			   <location>
				  <url>
					https://digital.libraries.ou.edu/cdm/landingpage/collection/dickens2
			 	  </url>
			    </location>
            </relatedItem>
		</xsl:when>
		<xsl:when test="contains(text(), 'Nichols Collection')">
			<relatedItem type="host">
			   <titleInfo>
					<title>
						<xsl:apply-templates/>
			   ...
			   <location>
				  <url>
					https://libraries.ou.edu/content/john-and-mary-nichols-rare-books-and-special-collections
			 	  </url>
			    </location>
            </relatedItem>	   
		</xsl:when>
    ...
    <xsl:template match="dc:rights">
        ...
        <accessCondition type="local rights statement">
            Please visit https://digital.libraries.ou.edu/TOU_WHC2.php for terms of use and attribution information.
        </accessCondition>
    </xsl:template>
</xsl:stylesheet>
